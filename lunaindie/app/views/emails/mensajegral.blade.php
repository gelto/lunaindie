                            ...
                            <tr>
                                ...
                                <td width="528" style="line-height:0px;font-size:0px;">
                                    <table width="528" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="528" height="40" align="left" style="font-family:Helvetica,Arial,Sans-serif;font-size:16px;line-height:18px;color:#0dbff2;"><strong>lunaindie.com - La red social del pr&eacute;stamo entre amigos.</strong></td>
                                        </tr>
                                        <tr>
        ...
        <td width="600" style="line-height:0px;font-size:0px;">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#242424">
                <tr>
                    ...
                    <td width="70" height="35" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:10px;line-height:14px;color:#666666;"><a title="lunaindie.com" href="{{ URL::to('/'); }}" target="_blank" style="color:#0dbff2;font-weight:bold;text-decoration:none!important;">INICIO</a></td>
                    <td width="100" height="35" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:10px;line-height:14px;color:#666666;"><a title="lunaindie.com" href="https://www.youtube.com/watch?v=Euc9gzMTv0c" target="_blank" style="color:#0dbff2;font-weight:bold;text-decoration:none!important;">COMO FUNCIONA</a></td>
                    <td width="150" height="35" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:10px;line-height:14px;color:#666666;"><a title="lunaindie.com" href="https://www.youtube.com/watch?v=lUKwQoxXI1U" target="_blank" style="color:#0dbff2;font-weight:bold;text-decoration:none!important;">CUENTAS ABIERTAS</a></td>
                    ...
                    <td width="150" height="35" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:10px;line-height:14px;color:#666666;"><a title="lunaindie.com" href="https://www.youtube.com/watch?v=gRzEoRG51V4" target="_blank" style="color:#0dbff2;font-weight:bold;text-decoration:none!important;">POR QUE ES GRATIS</a></td>
                    <td width="1" style="line-height:0px;font-size:0px;">
                        &nbsp;
                    </td>
                </tr>
    ...
    <tr><!-- INICIAN LEGALES -->
        <td width="600" style="line-height:0px;font-size:0px;">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                ...
                <tr>
                    <td width="600" height="18" align="center" style="font-family:Helvetica,Arial,Sans-serif;font-size:9px;font-weight:bold;line-height:12px;color:#666666;">Este mensaje fue enviado a {{ $email }} por lunaindie.com.</td>
                </tr>
                <tr>
